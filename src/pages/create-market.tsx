...
export default function CreateMarketPage() {
  return (
    <PageLayout mobileBarTitle="Create Market" metaTitle="Create Market - SOLAPE" contentButtonPaddingShorter>
      <div className="mb-4 text-2xl font-semibold text-white title mobile:text-lg justify-self-start">
...
function InputCreateMarketCard() {
  ...
  return (
    <Col className="gap-8 mx-auto w-[min(800px,100%)]">
      ...
      <Fieldset
        ...
        renderFormItem={
          <Input
            ...
            className={`p-3 ${newCreatedMarketId ? 'opacity-50 pointer-events-none' : ''} rounded-lg bg-[#161a1a]`}
      ...
      {newCreatedMarketId ? (
        <Row className="items-center self-center gap-5 w-min">
...
function Fieldset({ name, tooltip, renderFormItem }: { name: string; tooltip?: string; renderFormItem: ReactNode }) {
  ...
  return (
    <Grid className="grid-cols-[18em,1fr] mobile:grid-cols-1 gap-8 mobile:gap-4">
      <Row className="items-center justify-self-end mobile:justify-self-start">
...
function SelectTokenInputBox({
  ...
  return (
    <>
      <Grid
        className="grid items-center bg-[#161a1a] rounded-xl py-2 mobile:py-1.5 cursor-pointer px-3 mobile:px-2"
