...
import { RAYMint, SOLAPEMint, USDCMint, USDTMint } from '@/application/token/wellknownToken.config'
        ...
        <>
          <div className="px-8 pt-6 pb-5 mobile:px-6">
            ...
            <Row className="justify-between">
              {([SOLAPEMint, QuantumSOLVersionSOL, USDTMint, USDCMint] as const).map((mintish, idx) => {
